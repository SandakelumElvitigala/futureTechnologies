    ...
    var instances = []
      ...
      , Sequence = function(element, options) {
        ...
        function getStyle(element, property) {
            var value;
            return element.currentStyle ? value = element.currentStyle[property] : document.defaultView && document.defaultView.getComputedStyle && (value = document.defaultView.getComputedStyle(element, "")[property]),
            value
        }
        function addEvent(element, eventName, handler) {
            if (element.addEventListener)
                return element.addEventListener(eventName, handler, !1),
                handler;
            if (element.attachEvent) {
                var handlerr = function() {
                    handler.call(element)
                };
                return element.attachEvent("on" + eventName, handlerr),
                handlerr
            }
        }
        ...
        function convertTimeToMs(time) {
            ...
            return fraction = time.indexOf("ms") > -1 ? 1 : 1e3,
            convertedTime = "0s" == time ? 0 : parseFloat(time.replace("s", "")) * fraction
        }
        ...
        function addClass(elements, name) {
            ...
            for (isArray(elements) === !1 && (elementsLength = 1,
            elements = [elements]),
            elementsLength = elements.length,
            i = 0; elementsLength > i; i++)
                element = elements[i],
                hasClass(element, name) === !1 && (element.className += (element.className ? " " : "") + name)
        }
        function removeClass(elements, name) {
            var element, elementsLength, i;
            for (isArray(elements) === !1 ? (elementsLength = 1,
            elements = [elements]) : elementsLength = elements.length,
            i = 0; elementsLength > i; i++)
                element = elements[i],
                hasClass(element, name) === !0 && (element.className = element.className.replace(new RegExp("(\\s|^)" + name + "(\\s|$)"), " ").replace(/^\s+|\s+$/g, ""))
        }
        function insideElement(element, cursor) {
            var rect = element.getBoundingClientRect()
              , inside = !1;
            return cursor.clientX >= rect.left && cursor.clientX <= rect.right && cursor.clientY >= rect.top && cursor.clientY <= rect.bottom && (inside = !0),
            inside
        }
        function hasParent(parent, target, previousTarget) {
            if ("BODY" === target.nodeName)
                return !1;
            if (parent !== target)
                return previousTarget = target,
                hasParent(parent, target.parentNode, previousTarget);
        ...
        function getHammerDirection(swipeEvents) {
            ...
            return (void 0 !== swipeEvents.left || void 0 !== swipeEvents.right) && (swipeDirections += 1),
            (void 0 !== swipeEvents.up || void 0 !== swipeEvents.down) && (swipeDirections += 2),
            1 === swipeDirections ? hammerDirection = Hammer.DIRECTION_HORIZONTAL : 2 === swipeDirections ? hammerDirection = Hammer.DIRECTION_VERTICAL : 3 === swipeDirections && (hammerDirection = Hammer.DIRECTION_ALL),
            hammerDirection
        }
        function addFeatureSupportClasses($el, Modernizr) {
            var prefix = "seq-"
              , support = "no-touch";
            Modernizr.touch === !0 && (support = "touch"),
        ...
        var defaults = {
          ...
          , Modernizr = function(a, b, c) {
            ...
            var j, v, y, d = "2.8.3", e = {}, f = b.documentElement, g = "modernizr", h = b.createElement(g), i = h.style, l = ({}.toString,
            " -webkit- -moz- -o- -ms- ".split(" ")), m = "Webkit Moz O ms", n = m.split(" "), o = m.toLowerCase().split(" "), p = {
                svg: "http://www.w3.org/2000/svg"
            }, q = {}, t = [], u = t.slice, w = function(a, c, d, e) {
            ...
            return e.addTest = function(a, b) {
                if ("object" == typeof a)
                    ...
                    "undefined" != typeof enableClasses && enableClasses && (f.className += " " + (b ? "" : "no-") + a),
                    e[a] = b
                }
                return e
            }
        ...
        Array.prototype.indexOf || (Array.prototype.indexOf = function(searchElement, fromIndex) {
            ...
            0 > fromIndex && (fromIndex += length,
            0 > fromIndex && (fromIndex = 0)); length > fromIndex; fromIndex++)
        ...
        visibilityChange = "visibilitychange") : "undefined" != typeof document.mozHidden ? (hidden = "mozHidden",
        ...
        return self.ui = {
            ...
            getElements: function(type, option) {
                ...
                for (elements = option === !0 ? document.querySelectorAll("." + this.defaultElements[type]) : document.querySelectorAll(option),
                elementsLength = elements.length,
                i = 0; elementsLength > i; i++)
                    element = elements[i],
                    rel = element.getAttribute("rel"),
                    (null === rel || rel === self.$container.getAttribute("id")) && relatedElements.push(element);
                return relatedElements
            },
            show: function(element, duration) {
                self.propertySupport.transitions === !0 ? (element.style[Modernizr.prefixed("transitionDuration")] = duration + "ms",
                element.style[Modernizr.prefixed("transitionProperty")] = "opacity, " + Modernizr.prefixed("transform"),
                element.style.opacity = 1) : self.animationFallback.animate(element, "opacity", "", 0, 1, duration)
            },
            hide: function(element, duration, callback) {
                self.propertySupport.transitions === !0 ? (element.style[Modernizr.prefixed("transitionDuration")] = duration + "ms",
                element.style[Modernizr.prefixed("transitionProperty")] = "opacity, " + Modernizr.prefixed("transform"),
                element.style.opacity = 0) : self.animationFallback.animate(element, "opacity", "", 1, 0, duration),
                void 0 !== callback && (self.hideTimer = setTimeout(function() {
                    callback()
                }, duration))
            }
        },
        self.autoPlay = {
            init: function() {
                self.isAutoPlayPaused = !1,
                self.isAutoPlaying = !1
            },
            ...
            start: function(delay, continuing) {
                if (self.isAutoPlaying === !0 || self.isReady === !1)
                    return !1;
                var options = self.options;
                return delay = this.getDelay(delay, options.autoPlayDelay, options.autoPlayInterval),
                void 0 === continuing && self.started(self),
                addClass(self.$container, "seq-autoplaying"),
                addClass(self.$autoPlay, "seq-autoplaying"),
                options.autoPlay = !0,
                self.isAutoPlaying = !0,
                self.isAnimating === !1 && (self.autoPlayTimer = setTimeout(function() {
                    1 === options.autoPlayDirection ? self.next() : self.prev()
                }, delay)),
                !0
            },
            stop: function() {
                return self.options.autoPlay !== !0 || self.isAutoPlaying !== !0 ? !1 : (self.options.autoPlay = !1,
                self.isAutoPlaying = !1,
            ...
            unpause: function() {
                return self.isAutoPlayPaused !== !0 ? !1 : (self.isAutoPlayPaused = !1,
                this.start(!0),
                !0)
            },
            pause: function() {
                return self.options.autoPlay !== !0 ? !1 : (self.isAutoPlayPaused = !0,
                this.stop(),
                !0)
            }
        },
        self.canvas = {
            init: function(id) {
                void 0 !== self.$screen && (self.$screen.style.height = "100%",
                self.$screen.style.width = "100%"),
                self.canvas.getTransformProperties()
            },
            getSteps: function(canvas) {
                var stepId, step, i, steps = [], stepElements = canvas.children, stepsLength = stepElements.length;
                for (self.stepProperties = {},
                i = 0; stepsLength > i; i++)
                    step = stepElements[i],
                    stepId = i + 1,
                    steps.push(step),
                    self.stepProperties[stepId] = {},
                    self.stepProperties[stepId].isActive = !1;
                return steps
            },
            getTransformProperties: function() {
                ...
                for (i = 0; i < self.noOfSteps; i++)
                    ...
                    canvasTransform.seqX += -1 * step.offsetLeft,
                    canvasTransform.seqY += -1 * step.offsetTop,
            ...
            move: function(id, animate) {
                if (self.options.animateCanvas === !0) {
                    ...
                    return animate === !0 && self.firstRun === !1 && (duration = self.options.animateCanvasDuration),
                    self.isFallbackMode === !1 && (transforms = self.stepProperties[id].canvasTransform,
        ...
        self.animation = {
            getPhaseProperties: function(stepId) {
                var el, i, duration, delay, stepElement = self.$steps[stepId - 1], stepAnimatedChildren = stepElement.querySelectorAll("*[data-seq]"), stepChildren = stepElement.querySelectorAll("*"), stepChildrenLength = stepChildren.length, watchedDurations = [], watchedDelays = [], watchedLengths = [], durations = [], delays = [], lengths = [];
                for (i = 0; stepChildrenLength > i; i++)
                    el = stepChildren[i],
                    ...
                    null !== el.getAttribute("data-seq") && (watchedDurations.push(duration),
            ...
            getPhaseThreshold: function(ignorePhaseThreshold, phaseThresholdOption, isAnimating, currentPhaseDuration) {
                ...
                return isAnimating === !0 && self.options.ignorePhaseThresholdWhenSkipped === !0 && (ignorePhaseThreshold = !0),
                void 0 === ignorePhaseThreshold && (phaseThresholdOption === !0 ? phaseThresholdTime = currentPhaseDuration : phaseThresholdOption !== !1 && (phaseThresholdTime = phaseThresholdOption)),
                phaseThresholdTime
            },
            getReversePhaseDelay: function(currentPhaseTotal, nextPhaseTotal, phaseThresholdOption, ignorePhaseThresholdWhenSkippedOption, isAnimating) {
                var phaseDifference = 0
                  , current = 0
                  , next = 0;
                return phaseThresholdOption === !0 || ignorePhaseThresholdWhenSkippedOption !== !1 && isAnimating !== !1 || (phaseDifference = currentPhaseTotal - nextPhaseTotal,
                phaseDifference > 0 ? next = phaseDifference : 0 > phaseDifference && (current = Math.abs(phaseDifference))),
                {
                    next: next,
                    current: current
                }
            ...
            manageNavigationSkip: function(id, nextStepElement) {
                if (self.isFallbackMode !== !0) {
                    ...
                    if (self.ui.show(nextStepElement, 0),
                    self.options.navigationSkip === !0) {
                        if (self.navigationSkipThresholdActive = !0,
                        0 !== self.phasesAnimating && (clearTimeout(self.phaseThresholdTimer),
                        clearTimeout(self.nextPhaseStartedTimer),
                        self.options.fadeStepWhenSkipped === !0))
                            for (i = 1; i <= self.noOfSteps; i++)
                                stepProperties = self.stepProperties[i],
                                stepProperties.isActive === !0 && i !== id && (stepElement = self.$steps[i - 1],
                                stepId = i,
                                phaseSkipped = {},
            ...
            reverseProperties: function(phaseProperties, phaseDelay, phaseThresholdTime, ignorePhaseThreshold, options) {
                var el, i, duration, delay, total, maxTotal, maxWatchedTotal, animation = this, phaseElements = phaseProperties.children, noOfPhaseElements = phaseElements.length, stepDurations = phaseProperties.timings, timingFunction = "", timingFunctionReversed = "", totals = [], watchedTotals = [];
                for (i = 0; noOfPhaseElements > i; i++)
                    el = phaseElements[i],
                    duration = convertTimeToMs(getStyle(el, Modernizr.prefixed("transitionDuration"))),
                    delay = convertTimeToMs(getStyle(el, Modernizr.prefixed("transitionDelay"))),
                    total = duration + delay,
                    delay = stepDurations.maxTotal - total,
                    ignorePhaseThreshold !== !0 && (delay += phaseDelay),
                    total = duration + delay,
                    totals.push(total),
                    null !== el.getAttribute("data-seq") && watchedTotals.push(total),
                    options.reverseTimingFunctionWhenNavigatingBackwards === !0 && (timingFunction = getStyle(el, Modernizr.prefixed("transitionTimingFunction")),
                ...
                return maxTotal = Math.max.apply(Math, totals),
            ...
            forward: function(id, currentStepElement, nextStepElement, ignorePhaseThreshold, hashTagNav) {
                ...
                self.firstRun === !1 && animation.currentPhaseStarted(self.currentStepId),
            ...
            reverse: function(id, currentStepElement, nextStepElement, ignorePhaseThreshold, hashTagNav) {
                var reversePhaseDelay, currentPhaseProperties, nextPhaseProperties, currentPhaseTotal, nextPhaseTotal, animation = this, phaseThresholdTime = 0;
            ...
            startAnimateIn: function(id, currentPhaseTotal, nextStepElement, phaseThresholdTime, hashTagNav, nextPhaseTotal) {
                ...
                self.firstRun === !0 && self.pagination.update(),
                self.firstRun === !1 || self.options.startingStepAnimatesIn === !0 ? (self.stepProperties[id].isActive = !0,
                ...
                self.phaseThresholdTimer = setTimeout(function() {
                    ...
                    removeClass(nextStepElement, "seq-out"),
                    void 0 === nextPhaseTotal && (nextPhaseProperties = self.animation.getPhaseProperties(id, "next"),
                ...
                }, phaseThresholdTime)) : (animation.resetInheritedSpeed(id),
                self.phasesAnimating = 0,
                self.isAnimating = !1,
                self.options.autoPlay === !0 && self.autoPlay.start(!0),
                addClass(nextStepElement, "seq-in"),
                removeClass(nextStepElement, "seq-out")),
                self.firstRun = !1
            },
            startAnimateOut: function(id, currentStepElement, direction, currentPhaseTotal) {
                ...
                return 1 === direction ? (removeClass(currentStepElement, "seq-in"),
                addClass(currentStepElement, "seq-out"),
                currentPhaseProperties = animation.getPhaseProperties(id, "current"),
                currentPhaseTotal = currentPhaseProperties.watchedTimings.maxTotal) : removeClass(currentStepElement, "seq-in"),
                self.firstRun === !1 && (self.stepProperties[id].isActive = !0,
            ...
            nextPhaseStarted: function(id, hashTagNav) {
                self.phasesAnimating++,
                void 0 === hashTagNav && self.hashTags.update(),
            ...
            phaseEnded: function(id, phase, phaseDuration, callback) {
                ...
                phaseEnded = function(id) {
                    self.stepProperties[id].isActive = !1,
                    self.phasesAnimating--,
                    callback(id)
                }
                ,
            ...
            stepEnded: function(id) {
                self.isAnimating = !1,
                self.isAutoPlaying = !1,
                self.options.autoPlay === !0 && self.autoPlay.start(!0, !0),
            ...
            reverseTimingFunction: function(timingFunction) {
                ...
                for (timingFunction.indexOf("cubic-bezier") < 0 && (timingFunction = timingFunction.split(",")[0],
                ...
                i = 0; cubicBezierLength > i; i++)
                    cubicBezier[i] = parseFloat(cubicBezier[i]);
                return reversedCubicBezier = [1 - cubicBezier[2], 1 - cubicBezier[3], 1 - cubicBezier[0], 1 - cubicBezier[1]],
                timingFunction = "cubic-bezier(" + reversedCubicBezier + ")"
            },
            resetInheritedSpeed: function(step) {
                if (self.isFallbackMode !== !0) {
                    var el, i, stepElements = self.$steps[step - 1].querySelectorAll("*"), numberOfStepElements = stepElements.length;
                    for (i = 0; numberOfStepElements > i; i++)
                        el = stepElements[i],
            ...
            requiresFallbackMode: function(propertySupport) {
                var transitions = propertySupport.transitions
                  , isFallbackMode = !1;
                return transitions === !1 && (isFallbackMode = !0),
                isFallbackMode
            },
            getPropertySupport: function(properties) {
                var transitions = !1
                  , animations = !1;
                return Modernizr.csstransitions === !0 && (transitions = !0),
                Modernizr.cssanimations === !0 && (animations = !0),
                {
        ...
        self.animationFallback = {
                ...
                if (element !== !1) {
                    var start = (new Date).getTime()
                      , timer = setInterval(function() {
                        ...
                        1 === step && (void 0 !== callback && callback(),
                        clearInterval(timer))
                    }, 25);
            ...
            setupCanvas: function(id) {
                var i, step, stepId;
                if (self.isFallbackMode === !0)
                    for (addClass(self.$container, "seq-fallback"),
                    void 0 !== self.$screen && (self.$screen.style.overflow = "hidden",
                    self.$screen.style.width = "100%",
                    self.$screen.style.height = "100%"),
                    self.$canvas.style.width = "100%",
                    self.$canvas.style.height = "100%",
                    this.canvasWidth = self.$canvas.offsetWidth,
                    i = 0; i < self.noOfSteps; i++)
                        step = self.$steps[i],
                        stepId = i + 1,
            ...
            goTo: function(id, currentStep, currentStepElement, nextStep, nextStepElement, direction, hashTagNav) {
                ...
                void 0 === hashTagNav && self.hashTags.update(),
                self.pagination.update(),
                self.firstRun === !1 ? (this.moveCanvas(nextStepElement, currentStepElement, direction, !0),
                self.isAnimating = !0,
                self.animationStarted(self.currentStepId, self),
                self.stepEndedTimer = setTimeout(function() {
                    self.animation.stepEnded(self.currentStepId)
                }, self.options.fallback.speed)) : (this.moveCanvas(nextStepElement, currentStepElement, direction, !1),
                self.firstRun = !1,
                self.options.autoPlay === !0 && self.autoPlay.start(!0))
            }
        },
        self.pagination = {
            getLinks: function(element, rel) {
                var childElement, i, childElements = element.childNodes, childElementsLength = childElements.length, paginationLinks = [];
                for (i = 0; childElementsLength > i; i++)
                    childElement = childElements[i],
                    1 === childElement.nodeType && paginationLinks.push(childElement);
                return paginationLinks
            },
            update: function() {
                if (void 0 !== self.$pagination.elements) {
                    var i, j, currentPaginationLink, currentPaginationLinksLength, id = self.currentStepId - 1, paginationLength = self.$pagination.elements.length;
                    if (void 0 !== self.$pagination.currentLinks)
                        for (currentPaginationLinksLength = self.$pagination.currentLinks.length,
                        i = 0; currentPaginationLinksLength > i; i++)
                            currentPaginationLink = self.$pagination.currentLinks[i],
                            removeClass(currentPaginationLink, "seq-current");
                    for (self.$pagination.currentLinks = [],
                    j = 0; paginationLength > j; j++)
        ...
        self.hashTags = {
            init: function(id) {
                if (self.options.hashTags === !0) {
                    ...
                    "" !== newHashTag && (self.currentHashTag = newHashTag,
                    correspondingStepId = this.hasCorrespondingStep(self.currentHashTag),
                    correspondingStepId > -1 && (id = correspondingStepId + 1))
                }
                return id
            },
            hasCorrespondingStep: function(hashTag) {
                ...
                return correspondingStepId > -1 && (correspondingStep = correspondingStepId),
                correspondingStep
            },
            getStepHashTags: function() {
                var i, elementHashTag, stepHashTags = [];
                for (i = 0; i < self.noOfSteps; i++)
                    elementHashTag = self.options.hashDataAttribute === !1 ? self.$steps[i].id : self.$steps[i].getAttribute("data-seq-hashtag"),
            ...
            update: function() {
                if (self.options.hashTags === !0 && self.firstRun === !1 || self.options.hashTags === !0 && self.firstRun === !0 && self.options.hashChangesOnFirstStep === !0) {
                    ...
                    "" !== self.currentHashtag && (self.hasPushstate === !0 ? history.pushState(null, null, "#!" + self.currentHashTag) : location.hash = "#!" + self.currentHashTag)
                }
            },
            setupEvent: function() {
                if ("onhashchange"in window) {
                    if (window.addEventListener)
                        return window.addHashChange = function(func, before) {
                    ...
                    if (window.attachEvent)
                        return window.addHashChange = function(func) {
                ...
                window.removeHashChange = function(func) {
                    for (var i = hashChangeFuncs.length - 1; i >= 0; i--)
                        hashChangeFuncs[i] === func && hashChangeFuncs.splice(i, 1)
                }
                ,
        ...
        self.preload = {
            ...
            init: function(callback) {
                if (self.options.preloader !== !1) {
                    ...
                    return addClass(self.$container, "seq-preloading"),
                    ...
                    individualImagesToPreload = preload.getImagesToPreload(self.options.preloadTheseImages, !0),
            ...
            complete: function(callback) {
                self.preloaded(self),
                self.options.pausePreloader !== !0 && (this.toggleStepsVisibility("show"),
                ...
                (Modernizr.prefixed("animation") === !1 || Modernizr.svg === !1) && (self.$preloader[0].style.display = "none"),
                void 0 !== callback && callback())
            },
            addStyles: function() {
                if (self.options.preloader === !0) {
                    var head = document.head || document.getElementsByTagName("head")[0];
                    if (this.styleElement = document.createElement("style"),
                    ...
                    Modernizr.prefixed("animation") === !1 || Modernizr.svg === !1) {
            ...
            append: function() {
                return self.options.preloader === !0 ? (self.$preloader = document.createElement("div"),
                self.$preloader.className = "seq-preloader",
                self.$preloader = [self.$preloader],
                Modernizr.prefixed("animation") !== !1 && Modernizr.svg === !0 ? self.$preloader[0].innerHTML = self.preload.defaultHtml : self.$preloader[0].innerHTML = self.preload.fallbackHtml,
            ...
            toggleStepsVisibility: function(type) {
                if (self.options.hideStepsUntilPreloaded === !0) {
                    ...
                    for (i = 0; i < self.noOfSteps; i++)
                        step = self.$steps[i],
                        "hide" === type ? self.ui.hide(step, 0) : self.ui.show(step, 0);
                    return !0
                }
                return !1
            }
        ...
        self.manageEvents = {
            ...
            init: function() {
                return self.manageEvents.list[visibilityChange] = [],
                self.options.hashTags === !0 && this.add.hashChange(),
                self.options.swipeNavigation === !0 ? this.add.swipeNavigation() : self.hammerTime = !1,
                self.options.keyNavigation === !0 && this.add.keyNavigation(),
                this.add.resizeThrottle(),
                this.add.pageVisibility(),
                self.options.nextButton !== !1 && (self.$next = self.ui.getElements("nextButton", self.options.nextButton),
                this.add.button(self.$next, "nav", self.next)),
                self.options.prevButton !== !1 && (self.$prev = self.ui.getElements("prevButton", self.options.prevButton),
                this.add.button(self.$prev, "nav", self.prev)),
                self.options.autoPlayButton !== !1 && (self.$autoPlay = self.ui.getElements("autoPlayButton", self.options.autoPlayButton),
                this.add.button(self.$autoPlay, "nav", self.toggleAutoPlay)),
                this.add.stopOnHover(),
                self.options.pagination !== !1 && (self.$pagination = {},
            ...
            removeAll: function(eventList) {
                ...
                for (eventType in eventList)
                    eventList.hasOwnProperty(eventType) === !0 && (theEvents = eventList[eventType],
            ...
            add: {
                hashChange: function() {
                    ...
                    var handler = function(e) {
                        ...
                        self.currentHashTag !== newHashTag && (id = self.stepHashTags.indexOf(newHashTag) + 1,
                        self.currentHashTag = newHashTag,
                        self.goTo(id, void 0, void 0, !0))
                    };
                    return addHashChange(handler),
                ...
                button: function(elements, type, callback) {
                    ...
                    for (i = 0; elementsLength > i; i++)
                        element = elements[i],
                        rel = element.getAttribute("rel"),
                        rel === self.$container.id && null === element.getAttribute("data-seq-button") ? (element.setAttribute("data-seq-button", !0),
                        buttonEvent(element, rel)) : null === rel && null === element.getAttribute("data-seq-button") && buttonEvent(element, rel),
                ...
                stopOnHover: function() {
                    ...
                    handler = addEvent(self.$container, "mousemove", function(e) {
                        ...
                        self.isTouched === !0 ? void (self.isTouched = !1) : void (insideElement(self.$container, e) === !0 ? (self.options.autoPlayPauseOnHover === !0 && self.isMouseOver === !1 && self.autoPlay.pause(),
                        self.isMouseOver = !0) : (self.options.autoPlayPauseOnHover === !0 && self.isMouseOver === !0 && self.autoPlay.unpause(),
                        self.isMouseOver = !1))
                    }),
                    ...
                    handler = addEvent(self.$container, "mouseleave", function(e) {
                        self.options.autoPlayPauseOnHover === !0 && self.autoPlay.unpause(),
                        self.isMouseOver = !1
                    }),
                ...
                keyNavigation: function() {
                    var handler = addEvent(document, "keyup", function(event) {
                        ...
                        switch (keyCodeChar > 0 && keyCodeChar <= self.noOfSteps && self.options.numericKeysGoToSteps && self.goTo(keyCodeChar),
                        event.keyCode) {
                        case 37:
                ...
                resizeThrottle: function() {
                    function throttledEvents() {
                        setTimeout(function() {
                            self.canvas.getTransformProperties(),
                            self.propertySupport.transitions === !0 && self.canvas.move(self.currentStepId, !1)
                        }, 500),
        ...
        self.init = function(element) {
            ...
            1 === self.options.autoPlayDirection ? (prevStepId = id - 1,
            self.prevStepId = 1 > prevStepId ? self.noOfSteps : prevStepId) : (prevStepId = id + 1,
            ...
            goToFirstStep = function() {
                self.animation.domDelay(function() {
                    ...
                    self.isReady = !0,
                    self.ready(self),
                    self.goTo(id, self.options.autoPlayDirection, !0)
                })
            }
            ,
        ...
        self.destroy = function() {
            ...
            void 0 !== self.$screen && self.$screen.removeAttribute("style"),
            ...
            return lastStep = self.$steps[self.options.startingStepId - 1],
        ...
        self.next = function() {
            ...
            return nextStepId > self.noOfSteps && self.options.cycle === !1 ? !1 : (nextStepId > self.noOfSteps && (nextStepId = 1),
        ...
        self.prev = function() {
            ...
            return 1 > prevStepId && self.options.cycle === !1 ? !1 : (1 > prevStepId && (prevStepId = self.noOfSteps),
            self.options.reverseWhenNavigatingBackwards === !0 && (direction = -1),
            self.goTo(prevStepId, direction),
            prevStepId)
        }
        ,
        self.toggleAutoPlay = function(delay) {
            return self.isAutoPlaying === !1 ? self.start(delay) : self.stop(),
            self.isAutoPlaying
        }
        ,
        self.stop = function() {
        ...
        self.goTo = function(id, direction, ignorePhaseThreshold, hashTagNav) {
            if (direction = self.animation.getDirection(id, direction, self.currentStepId, self.noOfSteps, self.isFallbackMode, self.options.reverseWhenNavigatingBackwards, self.options.cycle),
            ...
            return clearTimeout(self.autoPlayTimer),
            self.direction = direction,
            1 === direction ? removeClass(self.$container, "seq-reversed") : addClass(self.$container, "seq-reversed"),
            ...
            self.isFallbackMode === !1 ? (self.animation.resetInheritedSpeed(id),
            (self.firstRun === !1 || self.firstRun === !0 && self.options.startingStepAnimatesIn === !0) && self.animationStarted(id, self),
            self.canvas.move(id, !0),
            self.animation.manageNavigationSkip(id, nextStepElement),
            1 === direction ? self.animation.forward(id, currentStepElement, nextStepElement, ignorePhaseThreshold, hashTagNav) : self.animation.reverse(id, currentStepElement, nextStepElement, ignorePhaseThreshold, hashTagNav)) : self.animationFallback.goTo(id, self.currentStepId, currentStepElement, id, nextStepElement, direction, hashTagNav),
            !0
        }
        ,
...
if ("function" == typeof define && define.amd)
    ...
    Hammer = "function" != typeof Hammer ? null : Hammer,
    imagesLoaded = "function" != typeof imagesLoaded ? null : imagesLoaded;
